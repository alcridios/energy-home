...
def save_contact_info(request):
    ...
    try:
        ...
        print('Error:\n{0}'.format(e))
        msg_error_contact = e
    return render(request, 'contacto.html', {'msg_success_contact' : msg_success_contact, 'msg_error_contact' : msg_error_contact})
...
def delete_client_and_contact_information(request):
    ...
    return render(request, 'subjects.html', {'clients' : clients_all(), 'contact_informations' : contact_information_all(), 'message_delete_error': message_delete_error})   